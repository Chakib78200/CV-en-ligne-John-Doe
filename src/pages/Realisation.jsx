...
import RestaurantAkira from '../images/Restaurant Akira.jpg';
import EspaceBienEtre from '../images/Espace bien-être.jpg';
            ...
            <article>
                <div className="container">
                    <div className="row row-site">
                        ...
                        <div className="col-12 col-md-6 col-lg-4 d-flex align-items-center justify-content-center mb-4">
                            <div className="card text-center">
                                <img src={RestaurantAkira} alt="Restaurant Akira" className="img-fluid card-img-top" />
                                <div className="card-item">
                                    <h2 className="margin-h2">Restaurant Akira</h2>
                        ...
                        <div className="col-12 col-md-6 col-lg-4 mb-4 mt-md-4 mt-lg-0 order-md-last">
                            <div className="card text-center">
                                <img src={EspaceBienEtre} alt="Espace Bien-être" className="img-fluid card-img-top" />
                                <div className="card-item">
                                    <h2 className="margin-h2">Espace bien-être</h2>
                                    <p>Réalisation d'un site vitrine pour un praticien <br />de bien-être.</p>
                                    <button type="button" className="btn btn-outline-primary">Voir</button>
                                    <hr className="color-gray" />
                                    <div className="border-site">
